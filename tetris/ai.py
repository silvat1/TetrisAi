...
class AI(object):
    def __init__(self, tetris):
        self.tetris = tetris
        self.heuristics = {
            heuristic.num_holes: -479,
            heuristic.num_blocks_above_holes: -55,
            heuristic.num_gaps: -130,
            heuristic.max_height: -518,
            heuristic.avg_height: -536,
            heuristic.num_blocks: 497,
        }
